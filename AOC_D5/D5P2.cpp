...
int main(){
  ...
  while(getline(crane,content)){
    ...
    cout<<organization[0][organization[0].size()-1]<<endl;
    cout<<organization[1][organization[1].size()-1]<<endl;
    cout<<organization[2][organization[2].size()-1]<<endl;
    cout<<"----------"<<endl;
  }
